...
rule1 = ctrl.Rule(bmi['underweight'] & (height['very short'] | height['short']) & activity['poor'], calorie['mediocre'])
rule2 = ctrl.Rule(bmi['underweight'] & (height['very short'] | height['short']) & activity['average'], calorie['average'])
rule3 = ctrl.Rule(bmi['underweight'] & (height['very short'] | height['short']) & activity['good'], calorie['decent'])
...
rule13 = ctrl.Rule(bmi['normal weight'] & (height['very short'] | height['short']) & activity['poor'], calorie['poor'])
rule14 = ctrl.Rule(bmi['normal weight'] & (height['very short'] | height['short']) & activity['average'], calorie['mediocre'])
rule15 = ctrl.Rule(bmi['normal weight'] & (height['very short'] | height['short']) & activity['good'], calorie['average'])
...
rule25 = ctrl.Rule(bmi['overweight'] & (height['very short'] | height['short']) & activity['poor'], calorie['dismal'])
rule26 = ctrl.Rule(bmi['overweight'] & (height['very short'] | height['short']) & activity['average'], calorie['poor'])
rule27 = ctrl.Rule(bmi['overweight'] & (height['very short'] | height['short']) & activity['good'], calorie['mediocre'])
...
rule37 = ctrl.Rule(bmi['obese'] & (height['very short'] | height['short']) & activity['poor'], calorie['dismal'])
rule38 = ctrl.Rule(bmi['obese'] & (height['very short'] | height['short']) & activity['average'], calorie['dismal'])
rule39 = ctrl.Rule(bmi['obese'] & (height['very short'] | height['short']) & activity['good'], calorie['poor'])
...
rule49 = ctrl.Rule(bmi['very obese'] & (height['very short'] | height['short']) & activity['poor'], calorie['dismal'])
rule50 = ctrl.Rule(bmi['very obese'] & (height['very short'] | height['short']) & activity['average'], calorie['dismal'])
rule51 = ctrl.Rule(bmi['very obese'] & (height['very short'] | height['short']) & activity['good'], calorie['dismal'])
...
while (end !="-1"):
	...
	print("BMI = %.3f \nYour suggested daily intake is %.3f calories." %(inpBMI,findCalorie.output['calorie']))
